...
def build_title_exploration_user_prompt(
    ...
    parts.append("- Accurately captures the paper's likely solution contribution and actual scope")
    ...
    parts.append("- Professional and suitable for a solution-oriented research paper or report")
    parts.append("- Uses mathematical title forms when the work is mathematical; mathematics, theorems, and proofs remain first-class when relevant")
    parts.append("- Does not imply completed experiments, measurements, implementations, or validation when the source contains only proposals")
