...
from backend.autonomous.agents.proof_formalization_agent import _assistant_workflow_mode_for_role
...
def test_compiler_rigor_formalization_uses_compiler_assistant_workflow():
    assert _assistant_workflow_mode_for_role("compiler_rigor_formalization") == "compiler"
