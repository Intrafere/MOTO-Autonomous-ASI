    ...
    <div className="inline-modal-overlay" style={{ zIndex: 10000 }} onClick={(event) => event.target === event.currentTarget && onClose()}>
      <div className="inline-modal-content" style={{ width: '620px', maxWidth: '90vw', backgroundColor: '#1a1a2e', borderRadius: '12px' }}>
        ...
        <p className="settings-hint">
          Enable Wolfram Alpha tool calls for computational verification during compiler/autonomous construction mode. Create a Wolfram Alpha App ID with the Short Answers API type selected (not Full Results). Wolfram will give you an App ID — that is your private API key to enter below. Wolfram Alpha is like giving your AI a very advanced calculator.
        </p>
